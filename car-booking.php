    ...
    public function render_booking_form() {
        ...
        <div class="cbs-booking-wrapper">
            <form id="car-booking-form">
                ...
                <input type="text" id="booking-date" name="booking_date" class="cbs-input" required>
	...
	public function render_locations_page() {
        ...
        <div class="wrap">
            ...
            <form method="post">
                ...
                <textarea name="cbs_locations" rows="15" style="width:100%; font-family:monospace;"><?php echo esc_textarea(json_encode($locations, JSON_PRETTY_PRINT)); ?></textarea>
